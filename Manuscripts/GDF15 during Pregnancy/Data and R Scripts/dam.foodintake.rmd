...
ggplot(aes(as.integer(week), kcals.consumed, col = Genotype))+
  ...
  scale_x_continuous(breaks=c(1,2,3,4,5,6,7),labels = c("-7.5","-0.5","7.5","14.5","21.5","28.5","35.5"))+
...
#Cumulative Food Intake
 intake.data.cleaned%>%
  ...
  theme(legend.position = c(0.1,0.85),legend.background = element_blank(), axis.text.x=element_text(size = 10))
