...
![](figures/weight-postnatal-2.png)<!-- -->

```
## 
## 	Shapiro-Wilk normality test
## 
## data:  postnatal.bw.data.cleaned$percent.loss[postnatal.bw.data.cleaned$Genotype == "Gdf15 Knockout"]
## W = 0.9, p-value = 0.4
```
...
## 	Shapiro-Wilk normality test
## 
## data:  postnatal.bw.data.cleaned$percent.loss[postnatal.bw.data.cleaned$Genotype == "Wild-type"]
## W = 0.9, p-value = 0.6
```
