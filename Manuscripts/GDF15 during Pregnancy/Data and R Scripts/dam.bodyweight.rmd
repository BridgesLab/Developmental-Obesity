...
ggplot(bw.data, aes(gest.age, gram.values, col = Genotype))+
  ...
  theme_bw()+
  theme(legend.position = c(0.1, 0.865), legend.background = element_blank(),text = element_text(size=14))
